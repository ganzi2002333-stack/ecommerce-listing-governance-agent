...
7. Demo 页面功能
   ...
   ![单条商品风险识别结果](screenshots/02_1single_review_result.png)
   ![单条商品风险识别结果](screenshots/02_2single_review_result.png)
   ![单条商品风险识别结果](screenshots/02_3single_review_result.png)
   ![规则检索结果](screenshots/03_retrieved_rules.png)
   ![分析结果](screenshots/04_batch_review_result.png)
